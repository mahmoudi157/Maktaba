...
public class BooksActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		linear3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				qa.setClass(getApplicationContext(), QuestionpapaerActivity.class);
				startActivity(qa);
			}
		});
		...
		_books_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				book.add(_childValue);
				gridview1.setAdapter(new Gridview1Adapter(book));
			}
	...
	private void initializeLogic() {
		...
		setTitle("Books");
		r.startRequestNetwork(RequestNetworkController.GET, "www.google.com", "space x", _r_request_listener);
		_setcornerradius(linear3, 20, 15, "#FFFFFF");
	...
	public class Gridview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			Glide.with(getApplicationContext()).load(Uri.parse(book.get((int)_position).get("image").toString())).into(imageview1);
			textview1.setText(book.get((int)_position).get("text").toString());
			_setcornerradius(linear1, 5, 5, "#FFFFFF");
			_setcornerradius(imageview1, 10, 10, "#ffffff");
			linear1.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View _view) {
					ii.setAction(Intent.ACTION_VIEW);
					ii.setData(Uri.parse(book.get((int)_position).get("link").toString()));
					startActivity(ii);
				}
			});
