...
public class Profile2Activity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		buypremium.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				Funct.showMessage(getApplicationContext(), "Comming soon! ");
			}
		});
		...
		feedback.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				con.setAction(Intent.ACTION_VIEW);
				con.setData(Uri.parse("mailto:textli@stayhome.li"));
				startActivity(con);
			}
		});
		...
		_fdb_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				if (_childKey.equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
					textviewname.setText(_childValue.get("name").toString());
					textviewemail.setText(_childValue.get("email").toString());
				}
				else {
	...
	private void initializeLogic() {
		setTitle("Profile");
		_setcornerradius(imageview5, 95, 0, "#FFFFFF");
		_setcornerradius(buypremium, 20, 20, "#FFFFFF");
		_setcornerradius(feedback, 20, 20, "#FFFFFF");
		_setcornerradius(contactus, 20, 20, "#FFFFFF");
		_setcornerradius(rate, 20, 20, "#FFFFFF");
	}
